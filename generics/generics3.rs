...
impl<T> std::fmt::Display for ReportCard<T>
where
	T: std::fmt::Display,
{
...
mod tests {
    ...
    fn generate_numeric_report_card() {
        ...
        assert_eq!(format!("{}", report_card), "Tom Wriggle (12) - achieved a grade of 2.1");
    }
    ...
    fn generate_alphabetic_report_card() {
        ...
        assert_eq!(format!("{}", report_card), "Gary Plotter (11) - achieved a grade of A+");
    }
}